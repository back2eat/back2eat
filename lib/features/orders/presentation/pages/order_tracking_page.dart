...
class _OrderTrackingPageState extends State<OrderTrackingPage> {
  ...
  void initState() {
    ...
    _fcmSub = NotificationService.instance.orderUpdateStream.listen((id) {
      if (id == widget.orderId && mounted) {
        _bloc.add(SilentRefreshOrderEvent(widget.orderId!));
      }
    });
  }
  ...
  // ── Smart back: pop if possible, else go home ─────────────────────────────
  void _goBack() {
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text('Keep Order', style: TextStyle(
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(backgroundColor: AppColors.danger,
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(10.r)), elevation: 0),
            onPressed: () {
              Navigator.pop(ctx);
              _bloc.add(CancelOrderEvent(
                orderId: orderId,
                reason: reasonCtrl.text.trim().isNotEmpty
                    ? reasonCtrl.text.trim() : null,
              ));
            },
              ...
              children: List.generate(5, (i) => GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Icon(i < _stars
                      ...
                      color: const Color(0xFFFFC107), size: 36.sp),
                ),
              )),
            ),
        ...
        child: Scaffold(
          ...
          body: BlocConsumer<OrderBloc, OrderState>(
            ...
            builder: (ctx, state) {
              ...
              void _extract(OrderEntity o) {
                currentStep    = _statusToStep[o.status] ?? 0;
                restaurantName = o.restaurantName.isNotEmpty
                    ? o.restaurantName : 'Back2Eat';
                ...
                orderId        = o.id;
                branchLat      = o.branchLatitude;
                branchLng      = o.branchLongitude;
              ...
              if      (state is OrderPlaced)       _extract(state.order);
              else if (state is OrderDetailLoaded) _extract(state.order);
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    _Card(child: Row(children: [
                      ...
                      if (isCancelled)
                        _StatusBadge(label: 'CANCELLED',
                            color: AppColors.danger),
                      if (isCompleted && !isCancelled)
                        _StatusBadge(label: 'DONE', color: AppColors.success),
                    ])),

                    SizedBox(height: 14.h),
                    Row(children: [
                      Text('Live Status', style: TextStyle(
                          fontSize: 13.sp, fontWeight: FontWeight.w900)),
                      const Spacer(),
                      Icon(Icons.sync, size: 16.sp, color: AppColors.muted),
                      SizedBox(width: 4.w),
                      Text('Auto-updating', style: TextStyle(
                    ...
                    ...List.generate(_steps.length, (i) {
                      final isDone   = i < currentStep && !isCancelled;
                      final isActive = i == currentStep && !isCancelled
                          && !isCompleted;
                      final color = isDone || isActive
                          ? AppColors.primary : AppColors.soft;
                      final IconData icon = isDone
                          ? Icons.check_rounded
                          : isActive ? Icons.timelapse_rounded
                          : Icons.more_horiz;
                        ...
                        child: _Card(child: Row(
                            ...
                            children: [
                              ...
                              Expanded(child: Column(
                                  ...
                                  children: [
                                    Row(children: [
                                      Expanded(child: Text(_steps[i].$1,
                                          style: TextStyle(fontSize: 14.sp,
                                              fontWeight: FontWeight.w900))),
                    ...
                    if (isCancelled) ...[
                      ...
                      _Card(child: Row(children: [
                        Container(
                          width: 38.w, height: 38.w,
                          decoration: BoxDecoration(color: AppColors.dangerSoft,
                              borderRadius: BorderRadius.circular(12.r)),
                        ...
                        child: _Card(child: Row(children: [
                          Container(
                            ...
                            child: Icon(Icons.star_rounded,
                                color: const Color(0xFFFFC107), size: 22.sp),
                          ),
                          SizedBox(width: 12.w),
                          Expanded(child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    if (branchLat != null && branchLng != null) ...[
                      ElevatedButton.icon(
                        ...
                        label: Text('Reach to Restaurant', style: TextStyle(
                      ...
                      if (branchAddress != null && branchAddress!.isNotEmpty)
                        Padding(
                          ...
                          child: Row(children: [
                            ...
                            SizedBox(width: 4.w),
                            Expanded(child: Text(branchAddress!,
                    ...
                    if (canCancel && orderId.isNotEmpty) ...[
                      OutlinedButton.icon(
                        ...
                        label: Text('Cancel Order', style: TextStyle(
                            color: AppColors.danger,
                            fontWeight: FontWeight.w800, fontSize: 14.sp)),
                    ...
                    OutlinedButton.icon(
                      onPressed: _goBack,  // ← fixed: smart back
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          SizedBox(width: 8.w),
          Expanded(child: Text(isWinner ? 'You Won!' : 'Lucky Draw Ticket',
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: isWinner ? Colors.black.withOpacity(0.12)
                : Colors.white.withOpacity(0.08),
            borderRadius: BorderRadius.circular(12.r),
            border: Border.all(color: isWinner
                ? Colors.black.withOpacity(0.2)
                : Colors.white.withOpacity(0.15)),
          ),
          child: Column(children: [
            Text('TICKET NUMBER', style: TextStyle(fontSize: 10.sp,
                fontWeight: FontWeight.w800,
                color: isWinner ? Colors.black.withOpacity(0.5)
                    : Colors.white.withOpacity(0.5),
                letterSpacing: 1.5)),
            SizedBox(height: 4.h),
            Text(order.luckyTicketNumber ?? '', style: TextStyle(
        ...
        if (drawTitle != null || prize != null) ...[
          SizedBox(height: 10.h),
          if (drawTitle != null) Text(drawTitle, style: TextStyle(
              fontSize: 12.sp, fontWeight: FontWeight.w700,
              color: isWinner ? Colors.black.withOpacity(0.7)
                  : Colors.white.withOpacity(0.7))),
          if (prize != null) ...[
            SizedBox(height: 2.h),
            Row(children: [
              Icon(Icons.card_giftcard_rounded, size: 14.sp,
                  color: isWinner ? Colors.black : Colors.white),
              SizedBox(width: 4.w),
              Text('Prize: $prize', style: TextStyle(fontSize: 12.sp,
                  fontWeight: FontWeight.w800,
                  color: isWinner ? Colors.black : Colors.white)),
            ]),
          ],
